...
| [[I18n]] | 10 languages × 343 keys, French template, English fallback; built-in game-type names are localized; the key *and* value checks; long-form rules are assets, not ARB; store locales differ | 2026-09-19 |
| [[Web]] | PWA specifics: sqlite3.wasm, OPFS, committed binaries and the check that gates them, `kIsWeb` guards, the wake lock under the CSP, base href | 2026-09-19 |
