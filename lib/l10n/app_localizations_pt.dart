...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get keypadShortcutTitle => 'Atalho do teclado';

  @override
  String get keypadShortcutKind => 'Tipo de tecla';

  @override
  String get keypadShortcutKindValue => 'Inserir um valor';

  @override
  String get keypadShortcutKindMultiply =>
      'Multiplicar a pontuação (só positiva)';

  @override
  String get keypadShortcutKindAdd => 'Somar à pontuação';

  @override
  String get keypadShortcutAmount => 'Número';

  @override
  String get keypadShortcutLabel => 'Texto da tecla (opcional)';

  @override
  String keypadShortcutAddRange(int min, int max) {
    return 'Um número inteiro entre $min e $max, diferente de 0';
  }

  @override
  String keypadShortcutAmountRange(int min, int max) {
    return 'Um número inteiro entre $min e $max';
  }
  ...
  @override
  String get lastPlayerOver => 'Último jogador em jogo (os outros acima)';

  @override
  String get lastPlayerUnder => 'Último jogador em jogo (os outros abaixo)';
  ...
  String get rankingEliminationNote =>
      'Classificação por ordem de eliminação: quem sai mais tarde fica à frente, independentemente dos totais.';
  ...
  String get analysisErrorGroupBudget =>
      'O seu grupo esgotou o orçamento de análises deste mês. É renovado no início do próximo mês.';

  @override
  String get analysisStyleGroupDefault =>
      'Nenhum estilo escolhido: este jogo partilhado é analisado no estilo e no idioma do grupo.';
  ...
  @override
  String get diceRoller => 'Lançar os dados';

  @override
  String get diceCount => 'Número de dados';

  @override
  String get diceRollAgain => 'Lançar de novo';
  ...
  @override
  String get thresholdIsRequired => 'Um limite é necessário para esta condição';
  ...
  String thresholdTooLarge(int max) {
    ...
    return 'O limite não pode exceder $maxString';
  }

  @override
  String get deletionImpossible => 'Exclusão impossível';
  ...
  String gameTypeInUse(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count jogos usam este tipo: não podem ser excluídos.',
      one: '1 jogo usa este tipo: não pode ser excluído.',
    );
    return '$_temp0';
  }
  ...
  String confirmDeleteGameType(String name) {
    return 'Você realmente deseja excluir o tipo de jogo \"$name\"?';
  }

  @override
  String get winDirectionChangeTitle => 'Inverter o vencedor?';
  ...
  String winDirectionChangeWarning(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'A classificação de $count jogos concluídos deste tipo será invertida: seus vencedores se tornarão os últimos.',
      one: 'A classificação de 1 jogo concluído deste tipo será invertida: seu vencedor se tornará o último.',
    );
    return '$_temp0';
  }
  ...
  String get winDirectionContradiction =>
      'A condição de fim de jogo recompensa o oposto do vencedor escolhido. Uma regra da casa pode querer exatamente isso.';

  @override
  String get rulesOutOfDateTitle => 'Atualizar as regras?';

  @override
  String get rulesOutOfDateMessage =>
      'As regras deste tipo ainda descrevem a condição anterior.';

  @override
  String get later => 'Mais tarde';

  @override
  String get currentIcon => 'Ícone atual';

  @override
  String get currentColor => 'Cor atual';

  @override
  String get groupDeviceClaimOwner => 'Assumir a propriedade';

  @override
  String groupDeviceClaimOwnerConfirm(String label) {
    return '“$label” é o proprietário do grupo, mas não dá sinal há muito tempo. Assumir a propriedade neste dispositivo?';
  }

  @override
  String get groupDeviceOwnerClaimed =>
      'Este dispositivo agora é o proprietário do grupo.';

  @override
  String get groupErrorOwnerActive =>
      'O proprietário do grupo deu sinal recentemente: não é possível assumir a propriedade.';

  @override
  String get groupCreatedOwnerExplain =>
      'Grupo criado. Este dispositivo é o proprietário; esse papel pode ser passado para outro em Dispositivos.';
  ...
  @override
  String get gameSounds => 'Sons do jogo';

  @override
  String get gameSoundsDescription =>
      'Um som quando um jogador é eliminado, quando a partida é ganha e quando o cronômetro termina';

  @override
  String get turnTimer => 'Cronômetro de turno';

  @override
  String get turnTimerLess => 'Menos tempo';

  @override
  String get turnTimerMore => 'Mais tempo';
  ...
  @override
  String get turnTimerReset => 'Redefinir';

  @override
  String get turnTimerTimeUp => 'Acabou o tempo!';

  @override
  String get configShareOpen => 'Partilhar por QR code';

  @override
  String get configShareTitle => 'Partilhar esta configuração';

  @override
  String get configShareExplainServer =>
      'Digitalize este código com outro telefone para o configurar com o mesmo servidor.';

  @override
  String configShareExplainGroup(String name) {
    return 'Digitalize este código com outro telefone para o configurar com o mesmo servidor e entrar no grupo $name. Contém o código de convite do grupo: mostre apenas às pessoas que deseja no grupo.';
  }

  @override
  String get configShareWebAppLabel => 'Endereço da aplicação web';

  @override
  String get configShareWebAppHelper =>
      'O endereço onde o seu servidor serve a aplicação web CountScore, por exemplo https://countscore.example.com/countscore. O código abre esta página.';

  @override
  String get configShareWebAppNeeded =>
      'Introduza o endereço da aplicação web para mostrar o código.';

  @override
  String get configShareQrLabel => 'QR code da ligação de configuração';

  @override
  String get configShareCopyLink => 'Copiar ligação';
  ...
  String replaceConfigLeavesGroup(String name) {
    return 'Este dispositivo vai sair do grupo $name. Os seus jogos ficam neste dispositivo.';
  }

  @override
  String get replaceConfigConfirm => 'Substituir';
  ...
  String replaceConfigUnsynced(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count alterações neste dispositivo ainda não chegaram ao grupo. Se sair agora, o grupo nunca as receberá.',
      one: '1 alteração neste dispositivo ainda não chegou ao grupo. Se sair agora, o grupo nunca a receberá.',
    );
    return '$_temp0';
  }

  @override
  String get replaceConfigLeaveAnyway => 'Sair assim mesmo';

  @override
  String get replaceConfigDone => 'Configuração substituída';

  @override
  String get replaceConfigUnchanged =>
      'Este dispositivo já usa esta configuração';

  @override
  String get joinLinkHandOverMessage =>
      'Esta ligação pode abrir na aplicação CountScore para Android. Se a aplicação não estiver instalada, abre a Play Store.';

  @override
  String get joinLinkOpenInApp => 'Abrir na aplicação';

  @override
  String get joinLinkContinueHere => 'Continuar no navegador';
}
