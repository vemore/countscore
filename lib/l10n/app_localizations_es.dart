...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get firstPlayerOver => 'Primer jugador en alcanzar';
  ...
  String get rankingEliminationNote =>
      'Clasificación por orden de eliminación: quien cae más tarde queda por delante, sea cual sea el total.';
  ...
  @override
  String get statsBestWinRate => 'Mejor porcentaje de victorias';
  ...
  String statsWinsOutOfGames(int wins, int games) {
    String _temp0 = intl.Intl.pluralLogic(
      wins,
      locale: localeName,
      other: '$wins victorias de $games',
      one: '$wins victoria de $games',
      zero: 'Ninguna victoria de $games',
    );
    return '$_temp0';
  }

  @override
  String get statsColumnPlayer => 'Jugador';
  ...
  String statsUnranked(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count partidas · aún sin clasificar',
      one: '$count partida · aún sin clasificar',
    );
    return '$_temp0';
  }
  ...
  String statsLeaderboardFooter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Clasificación a partir de $count partidas terminadas. Toca un jugador para ver su ficha.',
      one:
          'Clasificación a partir de $count partida terminada. Toca un jugador para ver su ficha.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get statsAverageRank => 'puesto medio';
  ...
  String statsRankChartTitle(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Puesto, últimas $count partidas',
      one: 'Puesto, última partida',
    );
    return '$_temp0';
  }

  @override
  String get statsTrendImproving => 'mejorando';

  @override
  String get statsTrendDeclining => 'en retroceso';

  @override
  String get statsTrendSteady => 'estable';
  ...
  String statsWinStreak(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Racha: $count victorias',
      one: 'Racha: $count victoria',
      zero: 'Sin racha en curso',
    );
    return '$_temp0';
  }
  ...
  @override
  String get statsAverageTotal => 'Total final medio';

  @override
  String get statsBestTotal => 'Mejor total final';

  @override
  String get statsMostBeaten => 'Rival más derrotado';

  @override
  String get statsOpenPlayerCard => 'ver la ficha';

  @override
  String get shareResult => 'Compartir el resultado';

  @override
  String get shareAnalysis => 'Compartir el análisis';
  ...
  String shareResultFooter(String appName, String url) {
    return 'Puntuaciones llevadas con $appName: $url';
  }

  @override
  String get shareFailed => 'No se pudo abrir el menú para compartir';

  @override
  String get newGameNameLabel => 'Nombre';

  @override
  String get newGameGameLabel => 'Juego';

  @override
  String newGameAllGames(int count) {
    return 'Todos los juegos ($count)';
  }

  @override
  String get newGamePlayersLabel => 'Jugadores · orden de juego';

  @override
  String get newGameDragToReorder => 'arrastra para reordenar';

  @override
  String get newGameDealer => 'reparte';

  @override
  String get newGameAddPlayer => 'Añadir un jugador';
  ...
  String newGameStart(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Empezar · $count jugadores',
      one: 'Empezar · 1 jugador',
      zero: 'Empezar',
    );
    return '$_temp0';
  }
  ...
  @override
  String get whoIsPlayingSearchHint => 'Nombre, o jugador nuevo';

  @override
  String get whoIsPlayingFrequent => 'Juega a menudo contigo';

  @override
  String whoIsPlayingSameAs(String gameName) {
    return 'Los mismos jugadores que «$gameName»';
  }
  ...
  String whoIsPlayingConfirm(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Añadir $count jugadores',
      one: 'Añadir 1 jugador',
      zero: 'Listo',
    );
    return '$_temp0';
  }
  ...
  @override
  String get pwaUpdateReady => 'Hay una nueva versión de CountScore lista';

  @override
  String get pwaUpdateReload => 'Recargar';

  @override
  String get thresholdIsRequired => 'Se requiere un umbral para esta condición';
  ...
  String thresholdTooLarge(int max) {
    ...
    return 'El umbral no puede exceder $maxString';
  }

  @override
  String get deletionImpossible => 'Eliminación imposible';
  ...
  String gameTypeInUse(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count juegos usan este tipo: no se pueden eliminar.',
      one: '1 juego usa este tipo: no se puede eliminar.',
    );
    return '$_temp0';
  }
  ...
  String confirmDeleteGameType(String name) {
    return '¿Realmente deseas eliminar el tipo de juego \"$name\"?';
  }

  @override
  String get winDirectionChangeTitle => '¿Invertir quién gana?';
  ...
  String winDirectionChangeWarning(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'La clasificación de $count juegos terminados de este tipo se invertirá: sus ganadores serán los últimos.',
      one: 'La clasificación de 1 juego terminado de este tipo se invertirá: su ganador será el último.',
    );
    return '$_temp0';
  }
  ...
  String get winDirectionContradiction =>
      'La condición de final del juego recompensa lo opuesto del ganador elegido. Una regla de la casa podría quererlo así.';

  @override
  String get rulesOutOfDateTitle => '¿Actualizar las reglas?';

  @override
  String get rulesOutOfDateMessage =>
      'Las reglas de este tipo aún describen la condición anterior.';

  @override
  String get later => 'Más tarde';

  @override
  String get currentIcon => 'Icono actual';

  @override
  String get currentColor => 'Color actual';
  ...
  @override
  String get configShareOpen => 'Compartir por código QR';

  @override
  String get configShareTitle => 'Compartir esta configuración';

  @override
  String get configShareExplainServer =>
      'Escanea este código con otro teléfono para configurarlo con el mismo servidor.';

  @override
  String configShareExplainGroup(String name) {
    return 'Escanea este código con otro teléfono para configurarlo con el mismo servidor y unirse al grupo $name. Contiene el código de invitación del grupo: muéstraselo solo a las personas que deseas que se unan al grupo.';
  }

  @override
  String get configShareWebAppLabel => 'Dirección de la aplicación web';

  @override
  String get configShareWebAppHelper =>
      'La dirección donde tu servidor sirve la aplicación web CountScore, por ejemplo https://countscore.example.com/countscore. El código abre esta página.';

  @override
  String get configShareWebAppNeeded =>
      'Introduce la dirección de la aplicación web para mostrar el código.';

  @override
  String get configShareQrLabel => 'Código QR del enlace de configuración';

  @override
  String get configShareCopyLink => 'Copiar enlace';
  ...
  String replaceConfigLeavesGroup(String name) {
    return 'Este dispositivo saldrá del grupo $name. Sus partidas se quedarán en este dispositivo.';
  }

  @override
  String get replaceConfigConfirm => 'Reemplazar';
  ...
  String replaceConfigUnsynced(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count cambios de este dispositivo aún no han alcanzado el grupo. Si te vas ahora, el grupo nunca los recibirá.',
      one: '1 cambio de este dispositivo aún no ha alcanzado el grupo. Si te vas ahora, el grupo nunca lo recibirá.',
    );
    return '$_temp0';
  }

  @override
  String get replaceConfigLeaveAnyway => 'Salir de todas formas';

  @override
  String get replaceConfigDone => 'Configuración reemplazada';

  @override
  String get replaceConfigUnchanged =>
      'Este dispositivo ya utiliza esta configuración';

  @override
  String get joinLinkHandOverMessage =>
      'Este enlace puede abrirse en la aplicación CountScore para Android. Si no está instalada, se abre Play Store en su lugar.';

  @override
  String get joinLinkOpenInApp => 'Abrir en la aplicación';

  @override
  String get joinLinkContinueHere => 'Continuar en el navegador';
}
