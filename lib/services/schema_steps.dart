/// Schema steps v12 onward, shared verbatim by both engines.
///
/// sqflite (`DatabaseService._upgradeDB`) runs them on native upgrades; Drift
/// (`AppDatabase.onUpgrade`) runs them on web. Keeping one list is what stops
