...
The mobile schema is **v20** and lives in two engines at once. The server schema is separate
...
- `lib/services/drift/database.dart` → `int get schemaVersion => 20;`
- `lib/services/database_service.dart` → `static const schemaVersion = 20;`
