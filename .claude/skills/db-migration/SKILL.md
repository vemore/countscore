...
The mobile schema is **v19** and lives in two engines at once. The server schema is separate
...
- `lib/services/drift/database.dart` → `int get schemaVersion => 19;`
- `lib/services/database_service.dart` → `static const schemaVersion = 19;`
